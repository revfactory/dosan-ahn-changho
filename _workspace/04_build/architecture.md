...
> **변경 이력 추가 (team-lead, 2026-06-07, D-27):** 소설 리더 평면 신설 — build_novel.py(멱등 md→html 장별 분할)·site/data/novel/(index+25본문)·novel.html/js/css(nv- 접두, D-25 모듈 CSS 패턴)·홈 #novel 진입 카드. 공유 모듈 시그니처 무변경, 기존 데이터 평면 무손상. 사용자 요청: 홈 하단 소설 보기 링크 + 마크다운 리더.
